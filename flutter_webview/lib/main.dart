...
class _WebPageState extends State<WebPage> {
  ...
  void _setup() async {
    ...
    final String contentBase64 =
        base64Encode(const Utf8Encoder().convert(kPage));
    print('loading');
  ...
  // Copied from: https://www.tutorialspoint.com/webgl/webgl_interactive_cube.htm
  // Modified to use touch input
  static const kPage = '''
  <!doctype html>
<html>
   <body>
      <canvas width = "300" height = "250" id = "my_Canvas"></canvas>
